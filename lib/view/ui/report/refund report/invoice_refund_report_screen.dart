...
import '../../../widget/report/refund report/refund_report_widget.dart';

class InvoiceRefundReportScreen extends StatelessWidget {
  InvoiceRefundReportScreen({super.key});
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: FilterReportWidget(
            ...
            reportWidget: RefundReportWidget(),
          ),
        ));
  }
}
